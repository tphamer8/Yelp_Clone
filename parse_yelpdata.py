...
def process_business_data():
    ...
    with open('./data/yelp_business.JSON','r') as f:
        outfile =  open('./data/yelp_business_output.txt', 'w')
        line = f.readline()
        count_line = 0
...
def process_checkin_data():
    ...
    with open('./data/yelp_checkin.JSON','r') as f:
        outfile =  open('./data/yelp_checkin_output.txt', 'w')
...
def process_user_data():
    ...
    with open('./data/yelp_user.JSON','r') as f:
        outfile =  open('./data/yelp_user_output.txt', 'w')
        line = f.readline()
        count_line = 0
...
def process_tip_data():
    ...
    with open('./data/yelp_tip.JSON','r') as f:
        outfile =  open('./data/yelp_tip_output.txt', 'w')
        line = f.readline()
        count_line = 1
        failed_inserts = 0
